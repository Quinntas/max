			...
			data: t.Array(
				t.Object({
					...
					contact: t.Object({
						...
						providerId: t.String(),
						dealershipId: t.Number(),
						channel: t.Nullable(t.String()),
						status: t.Nullable(t.String()),
						intent: t.Nullable(t.String()),
						qualificationScore: t.Nullable(t.Number()),
						timeline: t.Nullable(t.String()),
						budget: t.Nullable(t.String()),
						tradeIn: t.Nullable(t.Any()),
						vehicleInterest: t.Nullable(t.Any()),
						appointmentScheduled: t.Nullable(t.String()),
						crmExternalId: t.Nullable(t.String()),
					...
					lastMessage: t.Nullable(
						t.Object({
							...
							content: t.String(),
							contentType: t.Enum(MessageContentType),
							normalizedText: t.Nullable(t.String()),
							embedding: t.Nullable(t.String()),
							createdAt: t.Union([t.Date(), t.String()]),
							updatedAt: t.Union([t.Date(), t.String()]),
						}),
					),
